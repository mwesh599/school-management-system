...
<head>
	...
	<title>Welcome to <?=$setting['jkuat school']?></title>
...
<body class="body-home">
    <div class="black-fill"><br /> <br />
        ...
        <section class="welcome-text d-flex justify-content-center align-items-center flex-column">
        	<img src="log.png" >
        	<h4>Welcome to jkuat university</h4>
        	<p>Your path to excellence in education and research.</p>
        </section>
        <section id="about"
			  ...
			  <div class="row g-0">
			    ...
			    <div class="col-md-8">
			      <div class="card-body">
			        ...
			        <p class="card-text"><small class="text-muted">jkuat School</small></p>
			      </div>
			    </div>
			  </div>
			</div>
